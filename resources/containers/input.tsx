...
export interface InputProps<TForm> extends React.InputHTMLAttributes<HTMLInputElement> {
  name: string
  errors: TForm
  data: TForm
    ...
    return (
      <div>
        <InputComponent
          id={props.name}
          value={value}
          onInput={(e: React.ChangeEvent<HTMLInputElement>) => setData(props?.name, e.target.value)}
          ref={ref}
          {...props}
        />
